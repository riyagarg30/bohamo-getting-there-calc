...
export async function fetchDestinations() {
  try {
    ...
    //   (airport) => airport.iata && airport.type === "airport"
    // );
  } catch (error) {
...
export async function fetchCities() {
  try {
    ...
    // Filter only valid airports with associated cities
    return response.data
    //   .filter(
    //     (airport) => airport.iata && airport.type === "airport" && airport.city
    //   )
      .map((airport) => ({
...
export async function fetchRoutes(dep_iata, arr_iata) {
    return [
        {
          departure: {
            latitude: 28.5721,  // New Delhi, India
            longitude: 77.0369, // New Delhi, India
          },
          arrival: {
          ...
          airline: "Air India",
          flight_number: "AI101",
          connection: null, // Direct flight, no connection
        },
        {
          departure: {
            latitude: 28.5721,  // New Delhi, India
          ...
          connection: {
            departure: {
              latitude: 41.9742, // Chicago, USA
              longitude: -87.9073, // Chicago, USA
            },
            arrival: {
              latitude: 40.7128, // New York, USA
              longitude: -74.0060, // New York, USA
